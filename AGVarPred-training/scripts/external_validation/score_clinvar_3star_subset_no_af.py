#!/usr/bin/env python3
"""Score ClinVar 3+ Star SUBSET benchmark with the no-AF model."""
...
OUTDIR = EXT_DIR / "results/clinvar_3star_subset/no_af"
BENCHMARK_NAME = "clinvar_3star_subset"

if __name__ == "__main__":
    print("="*70)
    print(f"CLINVAR 3+ STAR SUBSET SCORING — Model: no_af")
    print("="*70)
