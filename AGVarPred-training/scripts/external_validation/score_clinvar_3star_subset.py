#!/usr/bin/env python3
"""Score ClinVar 3+ Star SUBSET benchmark with the regularized model."""
...
FEATURE_DIR = EXT_DIR / "processing/features/clinvar_3star_subset"
BENCHMARK_PATH = EXT_DIR / "benchmarks/benchmark_clinvar_3star_subset.csv"
MODEL_PATH = ROOT / "final_model_output_regularized/final_pipeline.pkl"
VEP_PATH = EXT_DIR / "vep/clinvar_3star_subset_vep.parquet"
OUTDIR = EXT_DIR / "results/clinvar_3star_subset/regularized"
BENCHMARK_NAME = "clinvar_3star_subset"

if __name__ == "__main__":
    print("="*70)
    print(f"CLINVAR 3+ STAR SUBSET SCORING — Model: regularized")
    print("="*70)
