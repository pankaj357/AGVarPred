#!/usr/bin/env python3
"""
Extract VEP annotations for Grimm2015 benchmark via Ensembl REST API.
Saves to external_validation/vep_preprocessed/grimm2015_vep.parquet
"""
...
def main():
    print("=" * 60)
    print("Grimm2015 VEP Extraction via Ensembl REST API")
    print("=" * 60)
