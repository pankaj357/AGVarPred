#!/usr/bin/env python3
"""Score VIP benchmark with the non-regularized (original) model."""
...
OUTDIR = EXT_DIR / "results/vip/regularized_no_af"
BENCHMARK_NAME = "vip"

if __name__ == "__main__":
    print("="*70)
    print(f"VIP BENCHMARK SCORING — Model: regularized_no_af")
    print("="*70)
