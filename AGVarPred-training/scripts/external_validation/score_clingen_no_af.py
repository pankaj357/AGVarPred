#!/usr/bin/env python3
"""Score ClinGen benchmark with the non-regularized (no-AF) model."""
...
FEATURE_DIR = EXT_DIR / "processing/features/clingen"
BENCHMARK_PATH = EXT_DIR / "benchmarks/benchmark_clingen.csv"
MODEL_PATH = ROOT / "model_6_minus_af_output/Model_1_no_AF_pipeline.pkl"
VEP_PATH = EXT_DIR / "vep_preprocessed/clingen_vep.parquet"
OUTDIR = EXT_DIR / "results/clingen/regularized_no_af"
BENCHMARK_NAME = "clingen"

if __name__ == "__main__":
    print("="*70)
    print(f"ClinGen BENCHMARK SCORING — Model: regularized_no_af")
    print("="*70)
