#!/usr/bin/env python3
"""
Run AlphaGenome feature extraction for ClinVar 3+ star benchmark.
...
INPUT_BASE = ROOT / "external_validation/processing/chunks/clinvar_3star"
OUTPUT_BASE = ROOT / "external_validation/processing/features/clinvar_3star"
LOG_DIR = ROOT / "external_validation/logs/clinvar"
...
def main():
    print(f"🚀 Starting ClinVar feature extraction")
