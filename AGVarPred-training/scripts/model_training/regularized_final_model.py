...
def load_dataset(path):
    files = sorted(glob(f"{path}/*.parquet"))
    dfs = []
...
if isinstance(shap_values, np.ndarray) and shap_values.ndim == 3:
    ...
    print("⚠️ Unexpected SHAP shape:", type(shap_values), getattr(shap_values, 'shape', None))
...
# Stratified bootstrap preserving class prevalence
